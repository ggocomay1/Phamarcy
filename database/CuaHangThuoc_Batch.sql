...
CREATE TABLE dbo.PhieuNhap (
    ...
    CONSTRAINT FK_PhieuNhap_NCC FOREIGN KEY (MaNCC) REFERENCES dbo.NhaCungCap(MaNCC)
);
GO
...
BEGIN
    ...
    BEGIN
        ...
        INSERT INTO dbo.LoHang(MaSanPham, SoLo, MaNCC, HanSuDung, GiaNhap, SoLuongNhap, SoLuongTon)
        VALUES (@MaSanPham, @SoLo, @MaNCC, @HanSuDung, @GiaNhap, @SoLuong, @SoLuong);
    END
...
VALUES (N'Dược A', N'028111', N'a@ncc.com', N'HCM');
GO

INSERT dbo.SanPham(TenSanPham, DonViTinh, GiaBanDeXuat, LoaiSanPham, MucTonToiThieu)
VALUES
(N'Paracetamol 500mg', N'Hộp', 15000, N'Thuoc', 10),
(N'Vitamin C',         N'Chai', 50000, N'ThucPhamChucNang', 10);
GO
