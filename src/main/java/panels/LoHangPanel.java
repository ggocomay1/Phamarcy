...
public class LoHangPanel extends JPanel {
	...
	private void initialize() {
		...
		var infoBanner = UIHelper.createInfoBanner("<html><b>Nghiệp vụ Lô hàng:</b> Quản lý chi tiết từng lô thuốc, theo dõi tồn kho và cảnh báo <b>hạn sử dụng</b> thực tế.</html>");
